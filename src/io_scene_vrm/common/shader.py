...
OUTPUT_GROUP_LIGHT_COLOR_FACTOR_COLOR_LABEL: Final = "Highlit Color"
OUTPUT_GROUP_LIGHT_COLOR_FACTOR_ALPHA_LABEL: Final = "Highlit Color Alpha"
OUTPUT_GROUP_LIGHT_COLOR_FACTOR_COLOR_DEFAULT: Final = (1.0, 1.0, 1.0)
OUTPUT_GROUP_LIGHT_COLOR_FACTOR_ALPHA_DEFAULT: Final = 1.0
